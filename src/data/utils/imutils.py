#############
# Description: From "Connecting Gaze, Scene, and Attention: Generalized Attention Estimation via Joint Modeling of Gaze and Scene Saliency"
# Author: Chong et al.
# URL: https://github.com/ejcgt/attention-target-detection/blob/master/utils/imutils.py
############
